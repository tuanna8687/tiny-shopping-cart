...
using TinyShoppingCart.Server.DataAccess.Extensions;

namespace TinyShoppingCart.Server.DataAccess.Repositories
{
    public class ProductCategoryRepository : IProductCategoryRepository
    {
        ...
        public ProductCategoryRepository(TinyShoppingCartDbContext context)
        {
            _context = context;
